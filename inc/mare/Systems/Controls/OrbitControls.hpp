...
class OrbitControls : public ControlsSystem<Transform>
{
    ...
    bool on_mouse_move(const RendererInput &input, Transform* transform) override
    {
    ...
    bool on_key(const RendererInput &input, Transform* transform) override { return false; }
    bool on_mouse_button(const RendererInput &input, Transform* transform) override { return false; }
    bool on_mouse_wheel(const RendererInput &input, Transform* transform) override { return false; }
    bool on_resize(const RendererInput &input, Transform* transform) override { return false; }
};
} // namespace mare
