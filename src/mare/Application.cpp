...
{
// Debug functions
std::string Application::debug_source_string(GLenum source)
{
    switch (source)
    {
...
std::string Application::debug_type_string(GLenum type)
{
    switch (type)
    {
...
std::string Application::debug_severity_string(GLenum severity)
{
    switch (severity)
    {
...
void GLAPIENTRY
Application::debug_message_callback(GLenum source,
                                    GLenum type,
                                    GLuint id,
                                    GLenum severity,
                                    GLsizei length,
...
{
    auto debug_state = get_app()->info.debug_mode;
...
void Application::run(Application* app_pointer)
{
    ...
    do
    {
        ...
        render(time, time - info.current_time);
